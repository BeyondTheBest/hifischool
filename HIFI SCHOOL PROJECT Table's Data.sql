...
create table subjects(Subject_Id varchar2(5) primary key,
			Subject_Name varchar(20),
			Subject_Max_Marks number(3),
			Created_By varchar2(20),
			Creation_Date date,
			Last_Updated_By varchar2(20),
			Last_Updation_Date date);
...
create table staff(Staff_Id varchar2(10) primary key,
...
create table extra_curr_act_master(Extra_Curr_Act_Id varchar2(20) primary key,
					...
					Last_Updated_By varchar(20),
					Last_Updation_Date date);
create table extra_curr_act_payments(Term_Id varchar2(10) references terms(Term_Id),
					Sports_Id varchar2(20) references sports_master(Sports_Id),
...
SQL> create type Vehicle_List is varray(20) of varchar2(20);
...
create table transport_enrollments_roaster(TR_Enroll_Roaster_Id varchar2(20) primary key,
						Transport_Route_Id varchar2(10) references transport(Transport_Route_Id),
						Student_No varchar2(20) references student(Student_No),
...
create table extra_curr_act_participation(CWS_Id varchar2(20) references class_wise_sports(CWS_Id),
						Student_No varchar2(20) references student(Student_No),
						Participation_Date date,
						Prize_Name varchar2(20),
						Prize_Date date,
...
create table section_wise_books(Section_Book_Id varchar2(20) primary key,
				...
				For_Education_Year number(2),
				Class_Id varchar2(20) references class(Class_Id),
				Book_Set_Approved_By varchar2(20),
				Book_Set_Approved_Date date,
				Set_Total_Books_Note number(3),
				Set_Total_Price number(9,2),
				Created_By varchar2(20),
				Creation_Date date,
				Last_Updated_By varchar2(20),
				Last_updation_Date date);
...
create table class_wise_feee(CWF_Id varchar2(20) primary key,
